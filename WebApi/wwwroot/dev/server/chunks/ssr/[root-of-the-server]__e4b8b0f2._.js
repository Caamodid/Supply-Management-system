...
"[project]/src/components/Sales/CustomerFormModal.tsx [app-ssr] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function CustomerFormModal({ open, mode, initialData, onClose, onSubmit }) {
  ...
  ========================= */ const validate = ()=>{
        ...
        if (!form.name.trim()) {
            ...
            __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$hot$2d$toast$2f$dist$2f$index$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["toast"].error(e.name);
        }
        if (!form.phone.trim()) {
            e.phone = "Phone number is required";
            __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$hot$2d$toast$2f$dist$2f$index$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["toast"].error(e.phone);
        }
        if (!form.customerType.trim()) {
            e.customerType = "Customer type is required";
            __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$hot$2d$toast$2f$dist$2f$index$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["toast"].error(e.customerType);
        }
        if (form.email && !/^\S+@\S+\.\S+$/.test(form.email)) {
            e.email = "Invalid email address";
            __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$hot$2d$toast$2f$dist$2f$index$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["toast"].error(e.email);
        }
        setErrors(e);
...
"[project]/src/components/Sales/CustomerTable.tsx [app-ssr] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$ui$2f$button$2f$Button$2e$tsx__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/components/ui/button/Button.tsx [app-ssr] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$form$2f$input$2f$InputField$2e$tsx__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/components/form/input/InputField.tsx [app-ssr] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$Sales$2f$CustomerFormModal$2e$tsx__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/components/Sales/CustomerFormModal.tsx [app-ssr] (ecmascript)");
...
function CustomerTable() {
  ...
  ========================= */ async function loadCustomers() {
        setLoading(true);
        try {
            const res = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$services$2f$sales$2e$service$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["SalesService"].getAllCustomers();
            setCustomers(res.data.data);
        } catch  {
            __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$hot$2d$toast$2f$dist$2f$index$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["default"].error("Failed to load customers");
        } finally{
            setLoading(false);
        }
    }
  ...
  ========================= */ async function handleSubmit(data) {
        try {
            if (mode === "add") {
                await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$services$2f$sales$2e$service$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["SalesService"].CreateCustomerAsyn(data);
                __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$hot$2d$toast$2f$dist$2f$index$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["default"].success("Customer created successfully");
            } else {
                if (!selectedCustomer?.id) return;
                await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$services$2f$sales$2e$service$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["SalesService"].updateCustomer(selectedCustomer.id, data);
                __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$hot$2d$toast$2f$dist$2f$index$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["default"].success("Customer updated successfully");
            }
            setOpenModal(false);
            loadCustomers();
        } catch  {
  ...
  ========================= */ async function confirmDelete() {
        ...
        try {
            setDeleting(true);
            await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$services$2f$sales$2e$service$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["SalesService"].deleteCustomer(selectedCustomer.id);
            __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$hot$2d$toast$2f$dist$2f$index$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["default"].success("Customer deleted successfully");
            setOpenDelete(false);
            loadCustomers();
        } catch  {
            __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$hot$2d$toast$2f$dist$2f$index$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["default"].error("Failed to delete customer");
        } finally{
            setDeleting(false);
        }
    }
  ...
  ========================= */ const filteredCustomers = customers.filter((c)=>c.name.toLowerCase().includes(search.toLowerCase()) || c.phone.toLowerCase().includes(search.toLowerCase()));
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
        ...
        children: [
                    ...
                    children: [
                        ...
                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("tbody", {
                            children: loading ? /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("tr", {
                                ...
                                lineNumber: 217,
                                columnNumber: 15
                            }, this) : filteredCustomers.map((c, i)=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("tr", {
            ...
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$Sales$2f$CustomerFormModal$2e$tsx__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["default"], {
                open: openModal,
                mode: mode,
...
//# sourceMappingURL=%5Broot-of-the-server%5D__e4b8b0f2._.js.map